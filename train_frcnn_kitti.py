...
def train_kitti():
    ...
    rpncallback = TensorBoard(log_dir='./logs/rpn', histogram_freq=1, batch_size=1, write_graph=True, write_grads=False, write_images=False, embeddings_freq=0, embeddings_layer_names=None, embeddings_metadata=None, embeddings_data=None, update_freq='epoch')
    classifiercallback = TensorBoard(log_dir='./logs/classifier', histogram_freq=1, batch_size=1, write_graph=True, write_grads=False, write_images=False, embeddings_freq=0, embeddings_layer_names=None, embeddings_metadata=None, embeddings_data=None, update_freq='epoch')
    allcallback = TensorBoard(log_dir='./logs/all', histogram_freq=1, batch_size=1, write_graph=True, write_grads=False, write_images=False, embeddings_freq=0, embeddings_layer_names=None, embeddings_metadata=None, embeddings_data=None, update_freq='epoch')
